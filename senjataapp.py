...
class WeaponApp:
    ...
    def page_3(self):
        self.clear_widgets()
        scrollable_frame = self.create_scrollable_frame()
        tk.Label(scrollable_frame, text="Data Senjata", font=("ThaleahFat", 50), bg="#404B6B", fg="white").pack(pady=40)

        for i, (namea, weapon, color) in enumerate(self.weapon_data, start=1):
            frame = tk.Frame(scrollable_frame, bg="#404B6B")
            frame.pack(pady=5)
            tk.Label(frame, text=f"{i}: {namea} {weapon}; {color}", font=("ThaleahFat", 15), bg="#404B6B", fg="white").pack(side="left", padx=5)
            tk.Button(frame, text="Pilih", command=lambda n=namea, w=weapon, c=color: self.page_4(n, w, c), bg="#FEAE35", font=("ThaleahFat", 15)).pack(side="left", padx=5)
            tk.Button(frame, text="Hapus", command=lambda i=i-1: self.delete_weapon(i), bg="#FEAE35", font=("ThaleahFat", 15)).pack(side="left", padx=5)

        tk.Button(scrollable_frame, text="Kembali", command=self.page_2, bg="#FEAE35", font=("ThaleahFat", 30)).pack(pady=20)
    ...
    def page_6(self):
        self.clear_widgets()
        scrollable_frame = self.create_scrollable_frame()
        tk.Label(scrollable_frame, text="Jenis Senjata", font=("ThaleahFat", 50), bg="#404B6B", fg="white").pack(pady=20)
        ...
        tk.Button(scrollable_frame, text="Tambah Jenis Senjata", command=self.add_weapon_type, bg="#FEAE35", font=("ThaleahFat", 15)).pack(pady=20)
        tk.Button(scrollable_frame, text="Kembali", command=self.page_8, bg="#FEAE35", font=("ThaleahFat", 15)).pack(pady=20)

    def page_7(self):
        self.clear_widgets()
        scrollable_frame = self.create_scrollable_frame()
        tk.Label(scrollable_frame, text="Warna Senjata", font=("ThaleahFat", 50), bg="#404B6B", fg="white").pack(pady=20)
        ...
        tk.Button(scrollable_frame, text="Tambah Warna Senjata", command=self.add_color, bg="#FEAE35", font=("ThaleahFat", 15)).pack(pady=20)
        tk.Button(scrollable_frame, text="Kembali", command=self.page_6, bg="#FEAE35", font=("ThaleahFat", 15)).pack(pady=20)

    def page_8(self):
        self.clear_widgets()
        scrollable_frame = self.create_scrollable_frame()
        tk.Label(scrollable_frame, text="Nama Senjata", font=("ThaleahFat", 50), bg="#404B6B", fg="white").pack(pady=20)
        ...
        tk.Button(scrollable_frame, text="Tambah Nama Senjata", command=self.add_name, bg="#FEAE35", font=("ThaleahFat", 15)).pack(pady=20)
        tk.Button(scrollable_frame, text="Kembali", command=self.page_5, bg="#FEAE35", font=("ThaleahFat", 15)).pack(pady=20)

    def page_training(self):
        self.clear_widgets()
        self.shoot_count = 0
        tk.Label(self.root, text="Latihan Menembak Senjata", font=("ThaleahFat", 50), bg="#404B6B", fg="white").pack(pady=50)

        self.shoot_label = tk.Label(self.root, text=f"Tembakan: {self.shoot_count}", font=("ThaleahFat", 30), bg="#404B6B", fg="white")
        self.shoot_label.pack(pady=20)

        tk.Button(self.root, text="Tembak", command=self.shoot, bg="#FEAE35", font=("ThaleahFat", 30)).pack(pady=20)
        tk.Button(self.root, text="Kembali", command=self.page_2, bg="#FEAE35", font=("ThaleahFat", 30)).pack(pady=10)
        tk.Button(self.root, text="Hasil", command=self.show_results, bg="#FEAE35", font=("ThaleahFat", 30)).pack(pady=10)
    ...
    def show_results(self):
        ...
        tk.Button(button_frame, text="SELESAI", command=self.root.quit, bg="#FEAE35", font=("ThaleahFat", 30)).pack(side="left", padx=20)
